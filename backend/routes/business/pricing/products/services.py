...
class ProdutoService:
    ...
    async def listar_produtos(self, ambiente: str, filtros: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
    ...
    async def obter_produto_detalhe(self, ambiente: str, produto_id: int) -> Dict[str, Any]:
    ...
    async def exportar_produtos(self, ambiente: str, formato: str, filtros: Optional[Dict[str, Any]]) -> bytes:
        """
        ...
        dados = await self.listar_produtos(ambiente=ambiente, filtros=filtros)
